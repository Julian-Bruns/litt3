...
Canonical statement: [cored_ring_and_marking_spectrum](../../Theorems/common_covers/cored_ring_and_marking_spectrum.md).
...
The [checked two-branch atlas theorem](../orbifolds/fixed_x_two_branch_bound.md)
