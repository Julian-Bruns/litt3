...
class OriginalChart:
    def __init__(self,tensor_path,chart,field_model=None,native_input=False,retain_terms=False):
        ...
        from scripts.atlases.algebra.atlas_field_maps import from_power_coordinates
        ...
        if native_input:
            from scripts.atlases.native.atlas_native_tensor_input import NativeTensorInput,cache_path
        ...
        from scripts.atlases.atlas_coefficient_codec import canonical_coefficient_decoder
        ...
        from scripts.atlases.algebra.atlas_field_maps import inverse_frobenius_map
        ...
        from scripts.atlases.native.atlas_resources import release_scratch
        release_scratch()
