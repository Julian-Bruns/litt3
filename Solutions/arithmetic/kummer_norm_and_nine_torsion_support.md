...
Canonical [statement](../../Theorems/arithmetic/kummer_norm_and_nine_torsion_support.md).
...
The [general pencil lemma](low_pencil_torsion_rigidity.md#2-a-second-difference-cannot-move-a-low-degree-class)
