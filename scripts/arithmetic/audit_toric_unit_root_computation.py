...
from scripts.arithmetic.toric_prym_unit_roots import multiply,power,extract_beta
from scripts.arithmetic.fixed_x_prym_toric import toric_model,newton_diagnostics
