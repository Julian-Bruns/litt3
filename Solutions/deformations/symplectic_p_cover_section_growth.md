...
[Statement](../../Theorems/deformations/symplectic_p_cover_section_growth.md).
...
on the endpoint, by [genus_two_active_twists](../genus_two/genus_two_active_twists.md).
...
[the abelian node proof, Section1](abelian_p_defect_node.md) gives
...
The argument in [proper theta, Section6](../genus_two/genus_two_active_theta.md)
