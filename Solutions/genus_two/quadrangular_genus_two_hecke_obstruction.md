...
group. See the source-checked [tame-lifting argument](../orbifolds/triangle344_frobenius_obstruction.md#1-complete-finite-census-and-its-characteristic-five-use).
...
The [backup arithmetic theorem](../../Theorems/genus_two/backup_curve_arithmetic.md)
...
The [degree24 theorem](../../Theorems/orbifolds/triangle246_frobenius_quotient_obstruction.md)
