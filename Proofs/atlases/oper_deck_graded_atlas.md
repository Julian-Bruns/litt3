...
[Statement](../../Theorems/atlases/oper_deck_graded_atlas.md).
Use `scalar_hermitian_data`, `wronskian_matrix_pencil`,
`dormant_differential_projection`, `fixed_x_oper_enumeration`, and
...
The exact script `scripts/atlases/orbit11_q_frame.sage` first checks (2) against
...
Reproduction: `scripts/atlases/orbit11_q_frame.sage --symbolic --census-algebra`,
