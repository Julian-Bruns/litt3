...
[Statement](../../Theorems/projective_connections/dormant_higgs_rank_reduction.md).
...
`scripts/connections/dormant_higgs_rank_check.sage` reads the saved first F25 oper,
...
`scripts/genus_two/alternating_kernel_genus_two_check.sage`. Its existing complete
