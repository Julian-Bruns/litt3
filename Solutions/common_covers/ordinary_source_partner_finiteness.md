...
[Statement](../../Theorems/common_covers/ordinary_source_partner_finiteness.md).
...
The [nilpotent scalar theorem](../connections/nilpotent_scalar_model.md) gives a
...
pair is [the canonical-double theorem](../connections/etale_double_dormant_pairs.md),
