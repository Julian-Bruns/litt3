...
Canonical statement: [stratified_contact_bound](../../Theorems/shared_tensors/stratified_contact_bound.md).
...
See [the contact theorem](contact_degree_bound.md), reduced-union
...
equality. The [finite-groupoid theorem](../quotient_geometry/finite_correspondence_groupoid.md)
...
[the canonical-quotient proof, Section3](../quotient_geometry/canonical_marked_quotient.md).
