...
Dependencies: [fixed arithmetic](../../curve_arithmetic/fixed_pair_arithmetic.md) and
[low Abel torsion](cyclic_cubic_low_abel_torsion.md).
[Proof and certificate](../../../Proofs/jacobians/torsion/weierstrass_pair_interpolation.md).
