...
[Statement](../Theorems/Thm_backup_wild120_atlas_exclusion.md).
...
The script scripts/verify_backup_wild120.sage uses the actual
...
Run, using an existing Sage installation:
    ...
    sage scripts/verify_backup_wild120.sage --chart generic
    sage scripts/verify_backup_wild120.sage --chart infinity
    sage scripts/verify_backup_wild120.sage --chart even
