...
[joint_tangent_clump_dormancy, Section4](joint_tangent_clump_dormancy.md)
...
[tangent_bundle_cyclic_refinements, Section1](../projective_connections/tangent_bundle_cyclic_refinements.md),
...
[genus_two_active_critical_quartics](../projective_connections/genus_two_active_critical_quartics.md),
...
[scripts/pointed_frobenius_theta_diagnostic.sage](../../scripts/arithmetic/pointed_frobenius_theta_diagnostic.sage)
implements(4)--(6). The single-process complete command is

```sh
sage scripts/arithmetic/pointed_frobenius_theta_diagnostic.sage --height 2 --all
```
