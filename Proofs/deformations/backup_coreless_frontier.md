...
The [complete backup theorem](../../Theorems/quotient_geometry/endpoint_exclusions/backup_cored_span_exclusion.md)
excludes every cored span. The
[two-primary Frobenius criterion](../curve_arithmetic/backup_curve_arithmetic.md#3-a-small-frobenius-congruence-controls-all23-torsion)
...
[the family singleton theorem](../../Theorems/jacobians/torsion/family_singleton_root_exclusion.md)
already excludes it for every alpha^5-alpha!=0. In the nonzero branch,
[the fixed-X profiles](../../Theorems/shared_tensors/fixed_x_nonzero_cartier_profiles.md)
...
[the family proof](../jacobians/torsion/family_small_torsion_specialization.md).
...
[the clump reduction](../../Theorems/shared_tensors/genus_two_clump_connection_reduction.md).
...
[the connection-spectrum theorem](../../Theorems/projective_connections/coreless_connection_spectrum.md)
allows an empty spectrum or a single dormant point. Parts 1--2 of
[the first-Witt theorem](../../Theorems/deformations/two_leg_negative_extensions.md)
