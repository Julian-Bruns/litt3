...
This removes ONE backup cored profile; the changing remainder is kept
only in [the backup state](../Research/BACKUP_CANDIDATE.md). It excludes
no arbitrary coreless span and does not change the selected main pair.
Both full census and quotient certificates
replay in under0.5 seconds, including an independent unpruned enumeration.

[Proof](../Solutions/Sol_triangle246_frobenius_quotient_obstruction.md) ·
