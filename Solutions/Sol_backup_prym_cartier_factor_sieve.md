...
[quadrangular_genus_two_hecke_obstruction](../Theorems/Thm_quadrangular_genus_two_hecke_obstruction.md)
is
...
scripts/fixed_x_prym_cartier.py computes the actual anti-form space by
...
by [backup_degree_two_prym_reduction](../Theorems/Thm_backup_degree_two_prym_reduction.md).
