...
[complete norm algebra](backup_hermitian_atlas_exclusion.md#1-complete-finite-candidate-list)
...
1-3, using [the Raynaud determinant](raynaud_genus_two_determinant.md).
