...
The explicit high-degree and backup applications are in the
[critical-quartic theorem](../genus_two/genus_two_active_critical_quartics.md).

Version4,2026-09-13: general statements unchanged; endpoint applications
consolidated in the critical-quartic record. Author proof; jet checks
PASS, no independent whole-theorem audit.
[Proof](../../Solutions/connections/etale_double_dormant_pairs.md).
