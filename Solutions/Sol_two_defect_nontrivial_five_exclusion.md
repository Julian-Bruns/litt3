...
[Statement](../Theorems/Thm_two_defect_nontrivial_five_exclusion.md).
...
[two-defect deck reduction](Sol_two_defect_deck_reduction.md) supplies
...
reference for h through EVERY W_(a+3), as required by
[uniform early descent](Sol_cyclic_power_early_descent.md). This uses
...
[prime-to5 defect-preserving descent](Sol_defect_preserving_etale_descent.md),
through the ORIGINAL h by the all-power early/late theorem (the earlier
5,25,125 results cover a<=3), and through the ORIGINAL neutral j by
...
[cyclic-five descent Section6](Sol_cyclic_five_delayed_descent.md) and
[defect-preserving descent](Sol_defect_preserving_etale_descent.md) gives
...
at most80640 family parameters per special-fiber bad double.
...
stability for the parameter avoidance. Thus the total is
    ...
    5^24 * 2^80000000 * 80640 < 2^80000073 < K.
...
[two-leg defect-orbit theorem](Sol_two_leg_defect_orbit_bound.md) applies
