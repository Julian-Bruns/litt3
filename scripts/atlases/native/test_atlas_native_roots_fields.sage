...
from scripts.atlases.algebra.atlas_field_maps import from_power_coordinates,inverse_frobenius_map
from scripts.atlases.native.atlas_native_roots import NativeRoots
from scripts.atlases.native.atlas_native_rref import NativeRref
from scripts.atlases.native.atlas_native_tensor_input import sha
...
report=dict(schema=1,representative=rep,field_kind=args.field_kind,intrinsic_degree_F5=n,
    ...
    native_source_sha256=sha((Path(__file__).resolve().parents[3] / 'scripts/atlases/atlas_frobenius_roots.cpp')),
