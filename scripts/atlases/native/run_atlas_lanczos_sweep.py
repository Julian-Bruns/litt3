...
def main():
    ...
    from scripts.atlases.verify_atlas_weak_points import verify as verify_weak_points
        ...
        try:
            ...
            if not result_path.exists():
                ...
                if result["primal_verified"] or result["dual_verified"]:
                    ...
                    assert run("scalar_verify", [sys.executable, str(ROOT / "scripts/atlases/algebra/verify_sparse_linear_certificate.py"),
