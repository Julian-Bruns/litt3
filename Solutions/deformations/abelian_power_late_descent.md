...
[Statement](../../Theorems/deformations/abelian_power_late_descent.md).
...
[the backup germs](../genus_two/backup_active_double_germs.md). These give the
...
[the cyclic-power proof, Sections1–5](cyclic_power_descent.md).
