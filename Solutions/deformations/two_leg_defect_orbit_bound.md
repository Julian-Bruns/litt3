...
[Statement](../../Theorems/deformations/two_leg_defect_orbit_bound.md).
...
[canonical dormant-pair identity](../connections/etale_double_dormant_pairs.md#2-factorization-of-the-linearized-curvature-on-the-same-curve)
...
[the tangent-bundle theorem](../connections/tangent_bundle_cyclic_refinements.md).
...
[effective cored avoidance](../atlases/bounded_atlas_partner_finiteness.md);
