...
[Statement](../../Theorems/arithmetic/cored_quotient_torsion_sieves.md).
...
so every function on X outside k(x) has degree>=7. The same
[pencil theorem](low_pencil_torsion_rigidity.md#1-the-quotient-by-constants-controls-independent-pencils)
gives degree≥26 for a function on the hyperelliptic Y outside k(t).
