...
2026-09-11. [Statement](../../../Theorems/jacobians/isogeny_sieves/backup_degree_two_prym_reduction.md).
...
map. The [complete Prym sieve](../../../Theorems/jacobians/isogeny_sieves/backup_double_cover_exclusion.md)
now excludes every carrier by the isogeny-factor test.

Inputs are [fixed-X arithmetic](../../curve_arithmetic/fixed_pair_arithmetic.md),
[backup arithmetic](../../curve_arithmetic/backup_curve_arithmetic.md), and the actual
