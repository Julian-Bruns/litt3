...
Canonical [statement](../../../Theorems/atlases/finite_algebras/finite_algebra_completion_certificates.md).
...
Another valid test first computes an actual Groebner basis of J,
then proves I subset J and dim R/J=D.
...
For example, exact consecutive lengths4,7,8,8 prove that the local
ring has length8; numerical stabilization would not.
