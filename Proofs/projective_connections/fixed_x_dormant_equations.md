...
Canonical [statement](../../Theorems/projective_connections/fixed_x_dormant_equations.md).

## Global regularity

The [arithmetic theorem](../../Theorems/curve_arithmetic/fixed_pair_arithmetic.md) gives
...
divide g-1. See the [rank-two proof](dormant_rank_two_candidates.md)
...
The exact census and local geometry are now proved in
[one separate argument](fixed_x_oper_enumeration.md). That proof
uses the global length above; the length does not depend on enumeration.
