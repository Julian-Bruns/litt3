...
[Statement](../../../Theorems/quotient_geometry/triangles/radical_quadratic_atlas_obstruction.md).
...
[tangent_bundle_cyclic_refinements](../../projective_connections/tangent_bundle_cyclic_refinements.md),Section1.
...
[The checker](../../../scripts/genus_two/backup_genus_two_cubic_tangents.sage) reconstructs
...
its halves, solve
    ...
    C²E−F/E=Q²,  C=c0+c1u,
    Q=q0+q1u+2u² (j=1), or Q=q0+q1u+c1u² (j=2).

Each system has sixteen distinct nonsingular solutions, with
U=Q/lead(Q), V=−CE mod U. The divisor of C+v/E is
2D−D_E−(4−j)O, so these are actual halves and exhaust the
degree-sixteen multiplication-by-two fiber. Moreover
h4=C²E+F/E+2Cv has divisor4D−8O. On z^4=h4 the character space
is z·L(D+2O)eta² with basis z·(1,u,(v+V)/U)eta²; finite and infinite
valuations prove completeness. All1,200 exact-order-four
oper/twist matrices have invertible minors. Their independent replay and
geometric dictionary are included in the
[small-packet audit](../../../Research/audits/BACKUP_CORED_COMPLETION_AUDIT_2026_09_11.md).
...
The [critical-quartic theorem](../../projective_connections/genus_two_active_critical_quartics.md)
gives the complete85-point backup list directly from its branch-pair formulas.
