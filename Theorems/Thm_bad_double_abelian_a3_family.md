...
and focused geometric audit PASS. No additional quartic exceptional factor.
...
common source, or an exclusion of all common covers. The independently
audited fixed-specialization theorem is retained as a separate check.

[Proof](../Solutions/Sol_bad_double_abelian_a3_family.md) ·
