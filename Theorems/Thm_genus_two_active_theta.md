...
2. For EVERY regular admissible active nilpotent projective connection
   ...
   [tangent_bundle_cyclic_refinements](Thm_tangent_bundle_cyclic_refinements.md)
...
3. Suppose additionally J(C) is ordinary, the canonical double is
   ...
   by [etale_p_witt_obstruction](Thm_etale_p_witt_obstruction.md).
...
[Proof and source qualifications](../Solutions/Sol_genus_two_active_theta.md).
