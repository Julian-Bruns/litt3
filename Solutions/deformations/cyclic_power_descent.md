...
[Statement](../../Theorems/deformations/cyclic_power_descent.md).
...
O_Y(W_t-O). The [genus-two active-twist theorem](../genus_two/genus_two_active_twists.md)
and [bad-double operator](bad_double_cubic_defect.md) give
...
[cyclic-tower section-growth theorem, Section8](symplectic_p_cover_section_growth.md)
...
[all-power matched two-defect exclusion](two_defect_nontrivial_five_exclusion.md).
