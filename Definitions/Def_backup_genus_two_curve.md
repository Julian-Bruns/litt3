# The small genus-two backup curve

Over k=bar(F5), choose alpha in F125 with alpha^3+alpha+1=0. Let C_alpha
be the smooth projective model of

    v^2=u(u-1)(u-2)(u-3)(u-alpha).
...
[arithmetic proof](../Solutions/genus_two/backup_curve_arithmetic.md).
