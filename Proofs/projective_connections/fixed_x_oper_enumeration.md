...
[Statement](../../Theorems/projective_connections/fixed_x_oper_enumeration.md). Work over the
specified F25, and base change to its algebraic closure when counting
geometric points. The [scalar chart theorem](../../Theorems/projective_connections/fixed_x_dormant_equations.md)
...
The [length-exhaustion lemma](../../Theorems/atlases/finite_algebras/finite_algebra_completion_certificates.md)
