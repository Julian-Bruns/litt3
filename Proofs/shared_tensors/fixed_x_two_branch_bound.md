# Proof: the fixed curve's two-branch atlas bound

[Statement](../../Theorems/shared_tensors/fixed_x_two_branch_bound.md).
Let X→S have one wild branch with1<delta/e<2 and one tame branch.
The argument first bounds the small wild groups, eliminates every
non-large HKG case, then isolates the two exceptional degrees.
...
The [two-primary W3 theorem](../jacobians/torsion/two_primary_w3.md) excludes this divisor
...
The [checked first-layer theorem](../quotient_geometry/local_actions/wild_first_layer.md)
...
The [original bounded-degree audit](../../routes/global/audits/CORED_FIXED_PAIR_BOUNDED_MINIMAL_DEGREE_AUDIT_2026_09_06.md)
checked both exact certificates; the
[all-quotients audit](../../routes/global/audits/GENUS9_ALL_EFFECTIVE_ORBIFOLD_QUOTIENTS_AUDIT_2026_09_06.md)
checked the one-endpoint scope. The
[all-orbifold theorem](../quotient_geometry/local_actions/fixed_x_orbifold_bound.md) uses this local bound.
