...
[Statement](../../../Theorems/jacobians/torsion/canonical_divisor_pencil_radical.md).
...
The exact script `scripts/genus_two/alternating_kernel_genus_two_check.sage` first
