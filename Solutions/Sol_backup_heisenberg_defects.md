...
[Statement](../Theorems/Thm_backup_heisenberg_defects.md).
...
Main scripts:
    ...
    scripts/heisenberg_frobenius_orbits.py
    scripts/verify_heisenberg_field_transport.py
    scripts/run_heisenberg_census.py
