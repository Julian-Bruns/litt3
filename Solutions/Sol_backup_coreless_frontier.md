...
The [complete backup theorem](../Theorems/Thm_backup_cored_span_exclusion.md)
excludes every cored span. Its audited small-packet calculation also
shows that the Abel curve B meets J(B)[8] only at its six Weierstrass
classes. The certificate is a combination of the ORIGINAL Hasse-jet
maximal minors equal to a power of the branch polynomial. It applies
over the algebraic closure, not just at rational points. Use this
exact calculation, rather than any general mixed-primary torsion
rigidity assertion or a high-degree specialization bound.
...
[the family singleton theorem](../Theorems/Thm_family_singleton_root_exclusion.md)
already excludes it for every alpha^5-alpha!=0. In the nonzero branch,
[the fixed-X profiles](../Theorems/Thm_fixed_x_nonzero_cartier_profiles.md)
give d=2 or 4. Therefore 2d[P-O]=0, so 8[P-O]=0, and the exact
backup test makes P Weierstrass.
...
[the family proof](Sol_family_small_torsion_specialization.md).
...
[the clump reduction](../Theorems/Thm_genus_two_clump_connection_reduction.md).
...
[the connection-spectrum theorem](../Theorems/Thm_coreless_connection_spectrum.md)
allows an empty spectrum or a single dormant point. Parts 1--2 of
[the first-Witt theorem](../Theorems/Thm_two_leg_negative_extensions.md)
