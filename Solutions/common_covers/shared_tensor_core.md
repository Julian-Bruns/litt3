...
[Statement and audit metadata](../../Theorems/common_covers/shared_tensor_core.md).
The all-weight assertion uses the separately audited
[canonical marked quotient](canonical_marked_quotient.md);
...
Use the [cored orbifold bridge](../orbifolds/cored_orbifold_bridge.md) to obtain
...
of any weight. The [fixed-X atlas theorem](../orbifolds/fixed_x_orbifold_bound.md)
