...
| Endomorphism packets | [Canonical packet and actual-map theorem](../../Theorems/Thm_etale_endomorphism_packets.md) consolidates95/96, exact abelian multiplicities, fixed-X abelian field, and minimal-source faithfulness. [98](../../routes/global/98_FULL_SIGNED_FROBENIUS_GROUP_AND_SHARP_PACKET_RANGE.md), [99](../../routes/global/99_SIGNED_GALOIS_CERTIFICATE_FOR_GEOMETRIC_ENDOMORPHISMS.md) retain the other endpoint arithmetic. Restricted-monodromy obstructions, not all common covers. |
