...
[Statement and author-proof metadata](../../Theorems/orbifolds/two_branch_tensor_patterns.md).
...
The [first-layer theorem](wild_first_layer.md) bounds the first
...
The [fixed genus-nine theorem](fixed_x_orbifold_bound.md) obtains
