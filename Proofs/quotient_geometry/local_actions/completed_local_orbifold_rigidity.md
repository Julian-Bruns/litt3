...
[Statement and audit metadata](../../../Theorems/quotient_geometry/local_actions/completed_local_orbifold_rigidity.md).
...
[the local-normality criterion, §3](unimodular_atlas_normality.md);
...
For the [Hermitian local filtration](hermitian_local_normality.md),
