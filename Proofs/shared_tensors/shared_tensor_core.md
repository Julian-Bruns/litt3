...
[Statement and audit metadata](../../Theorems/shared_tensors/shared_tensor_core.md).
...
of any weight. The [fixed-X atlas theorem](../quotient_geometry/local_actions/fixed_x_orbifold_bound.md)
