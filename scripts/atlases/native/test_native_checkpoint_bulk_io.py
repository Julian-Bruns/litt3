...
from pathlib import Path
from scripts.atlases.native.test_native_pencil_parallel import mathematical_checkpoint
...
def verify(output,io_fixture=True):
    ...
    original=runpy.run_path(str(ROOT/'scripts/atlases/mixed_atlas_certificate.sage'))['CPP_GENERAL']
