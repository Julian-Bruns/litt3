...
Use [triangle237_dormant_orbit_obstruction](../../../Theorems/quotient_geometry/triangles/triangle237_dormant_orbit_obstruction.md).
...
The audited [cofactor dictionary](../../../Theorems/quotient_geometry/triangles/triangle237_cofactor_necessary_system.md)
...
Reproduction uses
[assemble_degree84_provenance.py](../../../scripts/orbifolds/assemble_degree84_provenance.py)
...
[verify_polynomial_basis_identities.py](../../../scripts/atlases/algebra/verify_polynomial_basis_identities.py),
[verify_field_macaulay_certificate.py](../../../scripts/atlases/algebra/verify_field_macaulay_certificate.py)
and [verify_polynomial_identity_dag.py](../../../scripts/atlases/algebra/verify_polynomial_identity_dag.py).
