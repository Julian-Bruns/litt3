...
Version 3, 2026-09-13. The norm-complement lemma has a bounded audit;
the general polarization bound retains its author-proof status.
...
ψ:P→J/A with
    ...
    ker ψ=A∩P ⊂ J[n],       deg ψ=(n^h/κ)^2.

The kernel inclusion is scheme-theoretic, including when p divides n.
In particular, if [M] kills a point ψ(α), then [nM] kills α.
...
[Proof](../../Solutions/arithmetic/polarization_bad_fiber_bound.md).
