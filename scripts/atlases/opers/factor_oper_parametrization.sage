...
a=R(data['coordinates']['zeta'])
assert (a*a+4*a+2)%P==0
# Factorization needs these exact algebraic facts, not a stored status label.
# Completeness of the oper census is proved by verify_oper_census.sage.
