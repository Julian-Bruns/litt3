...
[Statement](../../Theorems/orbifolds/fixed_x_orbifold_bound.md).
...
[contact theorem](../common_covers/contact_degree_bound.md).
...
[the checked eigenform theorem, Section1](../connections/fixed_x_cartier_eigenforms.md):
...
[checked refinement argument](cored_orbifold_bridge.md).
...
[checked bounded-atlas finiteness theorem](../atlases/bounded_atlas_partner_finiteness.md)
...
[canonical-intersection and unique-clump classification](../common_covers/canonical_intersection.md).
...
[checked simple-root/core theorem](../common_covers/shared_tensor_core.md)
