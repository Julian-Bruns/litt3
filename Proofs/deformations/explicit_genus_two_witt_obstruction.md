...
[compute_genus2_w3_obstruction.py](../../scripts/deformations/compute_genus2_w3_obstruction.py).
...
It uses NumPy integer arithmetic, no numerical approximation or network.
    ...
    OPENBLAS_NUM_THREADS=1 python3 scripts/deformations/compute_genus2_w3_obstruction.py --precision 500
    OPENBLAS_NUM_THREADS=1 python3 scripts/deformations/compute_genus2_w3_obstruction.py --precision 800 --frobenius-variant 1
