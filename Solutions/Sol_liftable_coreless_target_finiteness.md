...
[Statement](../Theorems/Thm_liftable_coreless_target_finiteness.md).
Restored by /root2026-09-09 from the2026-09-05 collaborative author proof.
...
For our fixed X, [the audited atlas bound](Sol_fixed_x_orbifold_bound.md)
and [bounded-atlas finiteness](Sol_bounded_atlas_partner_finiteness.md)
already exclude cored partners for the prescribed Y_t. The new
[arithmetic count](Sol_arithmetic_genus_two_reduction_bound.md) gives
...
The class of Y_t has Frobenius25 orbit length r. Indeed its length
divides the prime degree r of t. If it were1, all r distinct conjugate
parameters would describe the same curve, contradicting the established
bound120 on parameters per geometric family class. Since E_(2,5) is
Frobenius-stable and smaller than r, it cannot contain Y_t. Section3
therefore excludes full mixed-characteristic lifts of ANY actual
common span for this SAME pair. This needs no additional choice of t
and no A18 computation.

[Refinement invariance](Sol_etale_refinement_deformations.md) shows that
...
[ordinary_source_partner_finiteness](Sol_ordinary_source_partner_finiteness.md)
rules out ordinary compatible common nilpotent connections for this
pair. [admissible_two_leg_w2_lifts](Sol_admissible_two_leg_w2_lifts.md)
