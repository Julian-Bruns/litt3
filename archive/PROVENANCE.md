...
the partial progress claimed can be viewed in
`../reference/synthesis_2026-06/litt3_partial_progress.pdf`, though the proofs
are somewhat less detailed than in the files. the suggested prompts for the
remaining open theorems were split into the six files under `../tasks/`.
