...
[Statement](../Theorems/Thm_two_leg_defect_orbit_bound.md).
2026-09-10. Focused medium audit PASS /root/audit_two_leg_defect_orbit.
New ingredients are
the actual-field degree inequality and its application to the two-defect
deck normal form. The scalar and effective counting inputs below retain
their existing evidence status.
...
[canonical dormant-pair identity](Sol_etale_double_dormant_pairs.md#2-factorization-of-the-linearized-curvature-on-the-same-curve)
...
[the tangent-bundle theorem](Sol_tangent_bundle_cyclic_refinements.md).
Thus the image in the audited
[two-defect deck theorem](Sol_two_defect_deck_reduction.md) is the actual
...
This is complementary to the full-canonical-X lifting route, rather
than a substitute for its still-open cyclic-five descent step.
...
[effective cored avoidance](Sol_bounded_atlas_partner_finiteness.md);
...
This finite set is F25-Frobenius stable. Each geometric genus-two class
has at most120 parameters in the displayed Y_t family, by the existing
six-branch-point normalization argument. Since r is prime and r>120,
the moduli Frobenius orbit of Y_t has length r, not one. Since r>K0,
