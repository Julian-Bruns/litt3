...
[Statement](../Theorems/Thm_backup_raynaud_quadric.md).
...
Replay (one core):
    ...
    OMP_NUM_THREADS=1 OPENBLAS_NUM_THREADS=1 MKL_NUM_THREADS=1 VECLIB_MAXIMUM_THREADS=1 sage scripts/backup_raynaud_quadric.sage
