...
[Statement and audit metadata](../../Theorems/orbifolds/completed_local_orbifold_rigidity.md).
...
[the local-normality criterion, §3](../atlases/unimodular_atlas_normality.md);
...
For the [Hermitian local filtration](../common_covers/hermitian_local_normality.md),
