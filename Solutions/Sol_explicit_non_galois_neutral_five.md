...
[Statement](../Theorems/Thm_explicit_non_galois_neutral_five.md).
...
## Reproduction
    ...
    sage -python scripts/explicit_nonordinary_dihedral5.py --output Research/computations/explicit_nonordinary_dihedral5.json
    sage -python scripts/analyze_dihedral5_hodge.py --input Research/computations/explicit_nonordinary_dihedral5.json --output Research/computations/explicit_nonordinary_dihedral5_fitting.json
...
scripts/audit_explicit_nonordinary_dihedral5.py.
...
preparation is in scripts/neutral5_hyperelliptic_hodge.py and
