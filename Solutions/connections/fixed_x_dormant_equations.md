...
Canonical [statement](../../Theorems/connections/fixed_x_dormant_equations.md).

## Global regularity

The [arithmetic theorem](../../Theorems/arithmetic/fixed_pair_arithmetic.md) gives
...
[one separate argument](../atlases/fixed_x_oper_enumeration.md). That proof
