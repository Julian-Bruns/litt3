...
from pathlib import Path
from scripts.atlases.native.atlas_native_batch import atomic,descendants,live_group_members,process_table,stop
...
def run(args):
    ...
    def launch(rep,kind):
        ...
        command=[args.sage,str(ROOT/'scripts/atlases/native/test_atlas_native_roots_fields.sage'),
