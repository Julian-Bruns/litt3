...
exec(compile(Path('scripts/atlases/opers/fixed_x_dormant_opers.sage').read_text(),'fixed','exec'))
...
# The complete census and its local C-block ranks prove lambda is a unit;
