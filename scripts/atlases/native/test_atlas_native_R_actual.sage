...
from scripts.atlases.native.atlas_native_R_checks import NativeRChecks,sha
...
output=Path(__file__).resolve().parents[4]/'litt3-computation-data/orbit11-structure'/('native-R-actual-'+rep)
