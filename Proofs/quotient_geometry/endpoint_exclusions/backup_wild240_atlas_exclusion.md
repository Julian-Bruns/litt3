...
[Statement](../../../Theorems/quotient_geometry/endpoint_exclusions/backup_wild240_atlas_exclusion.md).
The global primitive and fixed-base local coefficient are those proved
in [degree120](backup_wild120_atlas_exclusion.md); this proof checks
...
by120. [Replay](../../../scripts/genus_two/verify_backup_wild240.sage), using
`sage scripts/genus_two/verify_backup_wild240.sage --all`. Full run outcome:
