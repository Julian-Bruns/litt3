...
Apply [quadrangular_genus_two_hecke_obstruction](../../Theorems/genus_two/quadrangular_genus_two_hecke_obstruction.md).
...
For C_alpha the [arithmetic theorem](../../Theorems/genus_two/backup_curve_arithmetic.md) gives End0(J(C_alpha))
...
[complete backup cored theorem](../../Theorems/genus_two/backup_cored_span_exclusion.md).
