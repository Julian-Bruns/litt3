...
[Statement](../../Theorems/orbifolds/fixed_x_two_branch_bound.md).
...
[integral-jump theorem](integral_jump_bound.md)
...
The [two-primary W3 theorem](../arithmetic/two_primary_w3.md) excludes this divisor
...
The [checked first-layer theorem](wild_first_layer.md)
...
[all-orbifold theorem](fixed_x_orbifold_bound.md) uses this local bound.
