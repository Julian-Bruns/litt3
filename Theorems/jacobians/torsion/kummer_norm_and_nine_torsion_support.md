...
Dependencies: [fixed-pair arithmetic](../../curve_arithmetic/fixed_pair_arithmetic.md)
(author prose), and [low Abel torsion](cyclic_cubic_low_abel_torsion.md)
...
[Proof and replay instructions](../../../Proofs/jacobians/torsion/kummer_norm_and_nine_torsion_support.md).
