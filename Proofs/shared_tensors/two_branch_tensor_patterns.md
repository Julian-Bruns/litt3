...
[Statement and author-proof metadata](../../Theorems/shared_tensors/two_branch_tensor_patterns.md).
...
The [first-layer theorem](../quotient_geometry/local_actions/wild_first_layer.md) bounds the first
...
The [fixed genus-nine theorem](../quotient_geometry/local_actions/fixed_x_orbifold_bound.md) obtains
