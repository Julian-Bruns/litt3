...
scripts/fixed_x_prym_toric.py verifies every birational substitution and
every actual edge. scripts/toric_prym_unit_roots.py first compares its
...
are accumulated. scripts/audit_toric_unit_root_computation.py independently
