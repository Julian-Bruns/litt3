...
The ordinary-X/nontrivial-five branch remains, including the separate
cyclic-five delayed-descent Pro target. Higher defects, non-Galois
sources not covered by these hypotheses, dormant matches and absent
connection matches are not excluded. The full common-cover problem
remains open.

[Proof](../Solutions/Sol_two_leg_defect_orbit_bound.md) ·
