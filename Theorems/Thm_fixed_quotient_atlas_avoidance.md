...
every prime degree r=deg_F25(t)>max(N_H,120) excludes ALL such atlases.
...
Version1,2026-09-09. Author proof using the already audited covering-count
argument; this new corollary has not been independently audited or Lean
verified. [Proof](../Solutions/Sol_fixed_quotient_atlas_avoidance.md).
