...
[Statement](../Theorems/Thm_triangle238_frobenius_factor_obstruction.md).
...
[one-cover tame-specialization input](Sol_triangle344_frobenius_obstruction.md#1-complete-finite-census-and-its-characteristic-five-use)
...
[The verifier](../scripts/triangle238_certificate/verify48.py) checks every
...
[characters48.py](../scripts/triangle238_certificate/characters48.py)
...
The [C++ generator](../scripts/triangle238_certificate/enumerate48.cpp)
...
[the Hermitian quotient identity](Sol_hermitian_monodromy_genus_sieve.md)
and [completed backup atlas exclusion](Sol_backup_hermitian_atlas_exclusion.md),
[the quadrangular Hecke theorem](Sol_quadrangular_genus_two_hecke_obstruction.md),
and [the radical quadratic theorem](Sol_radical_quadratic_atlas_obstruction.md).
...
```sh
python3 scripts/triangle238_certificate/verify48.py
```
...
```sh
c++ -O3 -std=c++17 scripts/triangle238_certificate/enumerate48.cpp -o /tmp/triangle238
...
python3 scripts/triangle238_certificate/verify48.py /tmp/triangle238_tables.jsonl
```
