...
2. For EVERY regular admissible active nilpotent projective connection
   ...
   [tangent_bundle_cyclic_refinements](tangent_bundle_cyclic_refinements.md)
...
[Proof and source qualifications](../../Proofs/projective_connections/genus_two_active_theta.md).
