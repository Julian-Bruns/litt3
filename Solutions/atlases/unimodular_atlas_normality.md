...
Canonical statement: [unimodular_atlas_normality](../../Theorems/atlases/unimodular_atlas_normality.md).

## 1. The entire abstract canonical ring has two generators

Put the wild branch at t=0 and the tame branch at infinity. The
[cored ring valuation calculation](../common_covers/cored_ring_and_marking_spectrum.md)
