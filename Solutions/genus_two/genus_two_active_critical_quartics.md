...
[Statement](../../Theorems/genus_two/genus_two_active_critical_quartics.md).
...
[nilpotent_scalar_model](../../Theorems/connections/nilpotent_scalar_model.md).
...
[affine-family theorem](../../Theorems/genus_two/prime_field_branch_family.md)
...
The [universal dormant quintic](../../Theorems/genus_two/genus_two_dormant_quintic.md)
...
The [canonical-double theorem](../../Theorems/connections/etale_double_dormant_pairs.md)
then gives ten split active connections. It also gives, for each nonzero
two-torsion class L,

    #Dorm(Y_L)=5+2 #Active_L(Y)=15.

The [scalar determinant theorem](../connections/nilpotent_scalar_model.md#2-n-equations-their-exact-length-and-infinity)
