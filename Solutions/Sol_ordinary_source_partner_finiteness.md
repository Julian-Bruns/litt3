...
[Statement](../Theorems/Thm_ordinary_source_partner_finiteness.md).
...
The [nilpotent scalar theorem](Sol_nilpotent_scalar_model.md) gives a
...
contribute. For the displayed genus-two family, one isomorphism class
gives at most120 parameters: a branch-set projectivity is determined
by the images of0,1,infinity among six branch points. Those choices
determine the moving branch point after imposing the images of2,3.
Hence the parameter set is finite as well.
...
pair is [the canonical-double theorem](Sol_etale_double_dormant_pairs.md),
