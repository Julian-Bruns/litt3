...
from pathlib import Path
from scripts.atlases.native.atlas_native_tensor_input import NativeTensorInput,sha
...
class CubicDescendedChart:
    ...
    def original_comparison(self,verify_all_rows=False,native_input=False):
        from scripts.atlases.atlas_original_chart import OriginalChart
        from scripts.atlases.algebra.atlas_field_maps import verified_embedding
