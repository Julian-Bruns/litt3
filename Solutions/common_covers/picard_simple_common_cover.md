...
[Statement](../../Theorems/common_covers/picard_simple_common_cover.md).
...
are linked from [the computation record](../../Research/notes/genus_two/picard_cubic_common_cover_certificate.md).
