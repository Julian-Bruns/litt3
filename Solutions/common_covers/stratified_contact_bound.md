...
Canonical statement: [stratified_contact_bound](../../Theorems/common_covers/stratified_contact_bound.md).
...
equality. The [finite-groupoid theorem](finite_correspondence_groupoid.md)
...
[the canonical-quotient proof, Section3](canonical_marked_quotient.md).
